...
public class trSexoDTO {
    ...
    public trSexoDTO() {}     // Constructor por defecto

    public trSexoDTO(String trNombre) {
        this.trNombre = trNombre;
    }

    public trSexoDTO(Integer trIdSexo, String trNombre, String trEstado, String trFechaCreacion,String trFechaModificacion) {
